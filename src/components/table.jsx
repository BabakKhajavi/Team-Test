...
function TableContent(props) {
    const { dataList, columnTitles, columnList, pageSize, filter, onEdithandler, onModalView, placeholder } = props;
                                ...
                                {itemList().map((item, rowIndex) =>
                                    <tr key={rowIndex} className={(rowIndex % 2 === 0) ? "table-info" : "table-secondary"}>
                                        ...
                                        <td className="text-center">
                                            <Button onClick={() => onEdithandler(item)} className="btn btn-sm">{columnTitles[columnTitles.length - 2]}</Button>
                                        </td>
                                        <td className="text-center">
                                            <Button onClick={() => onModalView(item)} className="btn btn-sm">{columnTitles[columnTitles.length - 1]}</Button>
                                        </td>
                                    </tr>
                                )}
                            </tbody>
